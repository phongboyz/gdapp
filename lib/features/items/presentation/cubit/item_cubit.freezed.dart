...
abstract class $ItemStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({DataStatus status, Product? product, String? error});
...
class _$InitialImpl implements _Initial {
  const _$InitialImpl(
      {this.status = DataStatus.initial, this.product, this.error});
  ...
  @override
  String toString() {
    return 'ItemState(status: $status, product: $product, error: $error)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, status, product, error);
